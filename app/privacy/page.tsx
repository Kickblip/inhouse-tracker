  ...
  return (
    <main className="flex flex-col items-center min-h-screen w-full">
      ...
      <div className="w-full max-w-7xl mx-auto p-4 mb-24">
        ...
        <p>
          This Privacy Policy covers how Inhouse Tracker ("we," "us," or "our") manages your personal and non-personal
          information. This primarily includes data gathered from your usage of our website,{" "}
        ...
        <p>
          Inhouse Tracker is not intended for users under the age of 18. We do not knowingly the collect personal information of
